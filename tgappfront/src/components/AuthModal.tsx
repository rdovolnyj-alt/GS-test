          ...
          <>
            ...
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-[var(--c-bg)] px-2 text-[var(--c-text-40)]">или войти через соцсети</span>
              </div>
            </div>

            <div className="flex flex-col gap-2">
              <button onClick={onGoogle}
                className="flex items-center justify-center gap-2 w-full rounded-2xl border border-[var(--c-border)] bg-[var(--c-surface)] py-3 text-sm font-medium text-[var(--c-text-80)] hover:bg-[var(--c-surface-hover)] transition">
              ...
              <button onClick={onTelegram}
                className="flex items-center justify-center gap-2 w-full rounded-2xl border border-[var(--c-border)] bg-[#229ED9]/10 py-3 text-sm font-medium text-[#229ED9] hover:bg-[#229ED9]/20 transition">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
              ...
              <button onClick={onVK}
                className="flex items-center justify-center gap-2 w-full rounded-2xl border border-[var(--c-border)] bg-[#0077FF]/10 py-3 text-sm font-medium text-[#0077FF] hover:bg-[#0077FF]/20 transition">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
